...
public class TestMembersDAO {
	...
	public void testMembersDAOBasic() throws Exception
	{
		...
		Assert.assertEquals(true,mD.addMember(addMember));
		Assert.assertEquals(false,mD.addMember(addMember));
		Assert.assertEquals(false,mD.addMember(addMember2));
		...
		Assert.assertEquals(false,mD.addMember(addMember3));
		Assert.assertEquals(false,mD.addMember(addMember4));
		Assert.assertEquals(true,mD.addMember(addMember5));
		Member addMember6 = new Member(id1,"Brian","password2");
		Member addMember7 = new Member(id1,"Phill","password2");
		Assert.assertEquals(true,mD.addMember(addMember6));
		Assert.assertEquals(false,mD.addMember(addMember7));
